...
- 提供 benchmark、BFCL、tau2 mock、live provider compatibility matrix 与 real-network 回归能力。
...
当前已发布的小版本仍然是 `0.3.5`。README 里保留的 benchmark 与 public-eval headline 分数仍以 2026 年 4 月 14 日发布快照为基线，而 2026 年 4 月 20 日这轮最新的 Python 验证重新跑通了 live provider compatibility matrix 与 real-network 套件，但没有改写这组保留分数基线。方法说明、公开对比与详细矩阵见 [reference/zh/test-results.md](./reference/zh/test-results.md)。
